...
tags: [MASQUE, WARP, Zero Trust, QUIC, HTTP3, TLS, WireGuard, Cloudflare One]
---
...
|---|---|---|---|
| HTTP Semantics | HTTP 1.1 | HTTP/2 | HTTP/3 |
| Transport Security | TLS/SSL (optional) | TLS 1.2+ | TLS 1.3 |
...
Cloudflare is committed to continuing our mission to help build a better Internet, one that is more private and secure, scalable, reliable, and fast.
