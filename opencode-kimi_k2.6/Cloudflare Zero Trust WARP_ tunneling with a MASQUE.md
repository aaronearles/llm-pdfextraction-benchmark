---
source: 'Cloudflare Zero Trust WARP: tunneling with a MASQUE'
filename: Cloudflare Zero Trust WARP_ tunneling with a MASQUE.pdf
path: /mnt/c/Users/aearles/OneDrive - Pediatrix/Documents/code/gh_aaronearles/masque/Cloudflare
  Zero Trust WARP_ tunneling with a MASQUE.pdf
date_extracted: '2026-06-17T10:24:35.128270'
---

Zero Trust WARP: tunneling with a MASQUE 

## **Zero Trust WARP: tunneling with a MASQUE** 2024-03-06 
...
In June 2023, we told you that we were building a new protocol, MASQUE, into WARP. MASQUE is a fascinating protocol that extends the capabilities of 

1 of 10 

Zero Trust WARP: tunneling with a MASQUE 

HTTP/3 and leverages the unique properties of the QUIC transport protocol to efficiently proxy IP and UDP traffic without sacrificing performance or privacy 
...
Cloudflare’s network today spans more than 310 cities in over 120 countries, and interconnects with over 13,000 networks globally. HTTP/3 and QUIC were 

5 of 10 

Zero Trust WARP: tunneling with a MASQUE 

introduced to the Cloudflare network in 2019, the HTTP/3 standard was finalized in 2022, and represented about 30% of all HTTP traffic on our network in 2023. 
...
**==> picture [516 x 262] intentionally omitted <==**
...
AI Gateway now features real-time spend limits to prevent runaway token bills across multiple AI providers. By integrating with Cloudflare Access, companies can use identitydriven budgets and policies.... 
